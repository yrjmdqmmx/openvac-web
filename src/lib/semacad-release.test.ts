...
describe("SemaCAD release manifest", () => {
  ...
  it("rejects the internal staging release", () => {
    expect(() =>
      semacadReleaseManifestSchema.parse({
        ...verifiedPublicBeta,
        downloadUrl:
          "https://github.com/yrjmdqmmx/SemaCAD/releases/download/v0.2.0-beta.2-staging-2026080402/SemaCAD.dmg"
      })
    ).toThrow();
  });
  ...
  it.each([
    ...
    {
      releaseUrl: "https://github.com/yrjmdqmmx/SemaCAD/releases/tag/v0.2.0",
      downloadUrl:
        "https://github.com/yrjmdqmmx/SemaCAD/releases/download/v0.2.0/SemaCAD-0.2.0-public-beta-macOS26-arm64.dmg"
    },
    { minimumMacOS: "15.0" },
    { version: "0.2" }
  ])(
  ...
  it.each([
    {
      downloadUrl:
        "https://github.com/yrjmdqmmx/SemaCAD/releases/download/v0.2.0-beta.1/another-build.dmg"
    },
    {
      releaseUrl:
        "https://github.com/yrjmdqmmx/SemaCAD/releases/tag/v0.2.0-beta.2"
    },
    {
      version: "9.9.9"
    }
  ...
  it.each([
    ...
    { sizeBytes: 0 },
    { notarized: false },
    { downloadUrl: "https://github.com/yrjmdqmmx/SemaCAD/releases/latest" }
